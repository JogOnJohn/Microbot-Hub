...
public final class FarmingContractData {
    ...
    static final Map<Produce, String> CONTRACT_NAMES = ImmutableMap.<Produce, String>builder()
        .put(Produce.POTATO, "Potatoes")
        .put(Produce.ONION, "Onions")
        .put(Produce.CABBAGE, "Cabbages")
        .put(Produce.TOMATO, "Tomatoes")
        .put(Produce.STRAWBERRY, "Strawberries")
        .put(Produce.WATERMELON, "Watermelons")
        .put(Produce.MARIGOLD, "Marigolds")
        .put(Produce.NASTURTIUM, "Nasturtiums")
        .put(Produce.LIMPWURT, "Limpwurt roots")
        .put(Produce.WHITE_LILY, "White lillies")
        .put(Produce.REDBERRIES, "Redberries")
        .put(Produce.CADAVABERRIES, "Cadava berries")
        .put(Produce.DWELLBERRIES, "Dwellberries")
        .put(Produce.JANGERBERRIES, "Jangerberries")
        .put(Produce.WHITEBERRIES, "White berries")
        .put(Produce.POISON_IVY, "Poison ivy berries")
        .put(Produce.OAK, "Oak tree")
        .put(Produce.WILLOW, "Willow tree")
        .put(Produce.MAPLE, "Maple tree")
        .put(Produce.YEW, "Yew tree")
        .put(Produce.MAGIC, "Magic tree")
        .put(Produce.APPLE, "Apple tree")
        .put(Produce.BANANA, "Banana tree")
        .put(Produce.ORANGE, "Orange tree")
        .put(Produce.CURRY, "Curry tree")
        .put(Produce.PINEAPPLE, "Pineapple plant")
        .put(Produce.PAPAYA, "Papaya tree")
        .put(Produce.PALM, "Palm tree")
        .put(Produce.DRAGONFRUIT, "Dragonfruit tree")
        .put(Produce.POTATO_CACTUS, "Potato cacti")
        .put(Produce.CELASTRUS, "Celastrus tree")
        .put(Produce.REDWOOD, "Redwood tree")
        .build();
